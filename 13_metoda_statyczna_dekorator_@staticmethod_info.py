...
Dekorator @staticmethod w języku Python jest używany do tworzenia statycznych metod w klasach. Metody statyczne są funkcjami, które są związane z klasą, ale nie operują na instancjach ani nie mają dostępu do ich atrybutów. Dzięki temu dekoratorowi, metoda jest dostępna na poziomie klasy, a nie na poziomie instancji.


Główne cechy @staticmethod:

Nie przyjmuje automatycznie argumentu reprezentującego klasę lub instancję (brak self ani cls jako pierwszego argumentu).
...
potrzebujemy funkcji związanych z klasą, ale nie potrzebujemy dostępu do jej instancji ani 
jej atrybutów.
'''
